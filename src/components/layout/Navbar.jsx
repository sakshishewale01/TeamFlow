    ...
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white/80 px-4 backdrop-blur-md dark:border-slate-800 dark:bg-slate-900/80 sm:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          title="Notifications will be available in Phase 8"
        >
        ...
        <div className="flex items-center gap-2.5">
          {profile?.avatar_url ? (
            ...
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-linear-to-tr from-blue-600 to-indigo-600 text-white font-semibold text-xs shadow-xs">
              {initial}
            </div>
          )}
          ...
          <button
            ...
            className="inline-flex items-center justify-center h-8 w-8 rounded-lg text-slate-500 hover:bg-red-50 hover:text-red-600 dark:text-slate-400 dark:hover:bg-red-950/40 dark:hover:text-red-400 transition-colors cursor-pointer ml-1"
          >
