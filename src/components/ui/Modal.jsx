  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="min-h-screen px-4 text-center flex items-center justify-center">
        ...
        {/* Modal dialog */}
        <div
          className={`inline-block w-full ${sizeClasses} p-6 my-8 text-left align-middle transition-all transform bg-white dark:bg-slate-900 shadow-2xl rounded-2xl border border-slate-200 dark:border-slate-800 z-10 animate-slide-up`}
          role="dialog"
          aria-modal="true"
        >
